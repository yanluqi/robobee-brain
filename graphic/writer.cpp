...
Writer::Writer()
{
	...
	shader_prog = Shader::LoadShaders("../graphic/shaders/vertex_text.glsl", "../graphic/shaders/fragment_text.glsl");
	...
	if(FT_New_Face(ft, "../graphic/fonts/Ubuntu-RI.ttf", 0, &face)) {
